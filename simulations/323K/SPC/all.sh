...
mpirun -n 1 gmx_mpi mdrun -ntomp 8  -v -deffnm min -nsteps -1
rm \#*
...
mpirun -n 1 gmx_mpi mdrun -ntomp 8  -v -deffnm eq_nvt
rm \#*
...
mpirun -n 1 gmx_mpi mdrun -ntomp 8  -v -deffnm eq_npt
rm \#*
...
mpirun -n 1 gmx_mpi mdrun -ntomp 8  -v -deffnm run
rm \#*
