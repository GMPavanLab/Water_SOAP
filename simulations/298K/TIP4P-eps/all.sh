...
mpirun -n 4 gmx_mpi mdrun -v -deffnm min -nsteps -1
rm \#*
...
mpirun -n 4 gmx_mpi mdrun -v -deffnm eq_nvt
rm \#*
...
mpirun -n 4 gmx_mpi mdrun -v -deffnm eq_npt
rm \#*
...
mpirun -n 4 gmx_mpi mdrun -v -deffnm run
rm \#*
